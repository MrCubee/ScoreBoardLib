package fr.mrcubee.scoreboard.v1_15_R1;
...
public class CraftObjective extends Objective {
    ...
    public boolean removeScore(String playerName) {
        ...
        Reflection.setValue(packet, "d", ScoreboardServer.Action.REMOVE);
    ...
    private void updateScore(Player player, String playerName, int value) {
        ...
        Reflection.setValue(packet, "d", ScoreboardServer.Action.CHANGE);
        ((CraftPlayer) player).getHandle().playerConnection.sendPacket(packet);
    }
