package fr.mrcubee.scoreboard.v1_11_R1;
...
public class CraftObjective extends Objective {
    ...
    public boolean removeScore(String playerName) {
        ...
        Reflection.setValue(packet, "d", PacketPlayOutScoreboardScore.EnumScoreboardAction.REMOVE);
    ...
    private void updateScore(Player player, String playerName, int value) {
        ...
        Reflection.setValue(packet, "d", PacketPlayOutScoreboardScore.EnumScoreboardAction.CHANGE);
    }
